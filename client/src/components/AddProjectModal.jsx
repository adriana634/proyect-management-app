        ...
        <>
            { !loading && !error && ( 
                <>
                    ...
                    <div id="addProjectModal" className="modal fade" tabIndex="-1" aria-labelledby="addProjectModallLabel" aria-hidden="true">
                        <div className="modal-dialog">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 id="addProjectModalLabel" className="modal-title">New Project</h5>
